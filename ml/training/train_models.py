...
class ModelTrainer:
    ...
    def __init__(
        self, db_path: str = "data/events.duckdb", models_dir: str = "ml/models"
    ):
        """
    ...
    def load_data(self) -> Tuple[List[Dict], List[Dict]]:
        ...
        for row in artists_result:
            ...
            artist_lookup[artist_id] = {"name": artist_name, "genres": genres}
    ...
    def train_content_model(
        self, events: List[Dict], interactions: List[Dict] = None
        ...
        embedder = ContentEmbedder(
            model_name="all-MiniLM-L6-v2", cache_dir=str(self.models_dir / "embeddings")
        )

        self.content_model = ContentBasedRecommender(
            embedder=embedder, model_cache_dir=str(self.models_dir / "content_based")
        )
    ...
    def train_cf_model(
        self, interactions: List[Dict], embedding_dim: int = 64, num_epochs: int = 100
            ...
            try:
                if model_type == "content":
                    ...
                    recommendations = model.recommend(
                        user_prefs, candidate_event_ids=event_ids, num_recommendations=k
                    )
