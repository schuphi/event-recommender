...
class TikTokEventScraper:
    ...
    EVENT_HASHTAGS = [
        ...
        'copenhagennow', 'cphweekend', 'copenhagenweekend', 'copenhagenfun',
        'cphlife', 'copenhagenlife', 'visitcopenhagen', 'cphvibes',
        
        # Music and nightlife discovery 
        'copenhagenmusic', 'cphmusic', 'copenhagennight', 'cphnight',
        'copenhagennightlife', 'cphparty', 'copenhagenparty', 'cphclub',
        'copenhagenclub', 'klubaften', 'fest', 'technocopenhagen', 'cphtechno',
        
        # Neighborhood-specific trending
        'vesterbro', 'nørrebro', 'indrebr', 'christiania', 'østerbro',
        'vesterbrovibes', 'nørrebrovibes', 'indrebynight',
        
        # Event types that go viral
        'undergroundcph', 'secretparty', 'rooftopparty', 'warehouseparty',
        'ravecph', 'festivaler', 'koncert', 'livemusic', 'dj',
        
        # Trending/viral markers
        'fyp', 'trending', 'viral', 'mustsee', 'dontmiss', 'tonight',
        'thissaturday', 'weekend', 'eventanbefalinger', 'hidden gems'
    ]
    
    GENRE_KEYWORDS = [
        'techno', 'house', 'electronic', 'disco', 'funk', 'soul', 'jazz',
        'rock', 'punk', 'indie', 'alternative', 'pop', 'hiphop', 'rap'
    ]
    ...
    def scrape_venues(
        ...
        viral_hashtags = [
            'copenhagenevents', 'cphevents', 'copenhagentonight', 'cphtonight',
            'undergroundcph', 'secretparty', 'rooftopparty', 'copenhagenmusic',
            'cphlife', 'vesterbrovibes', 'nørrebrovibes', 'technocopenhagen'
        ]
                ...
                for video in videos:
                    try:
                        ...
                        if self._is_event_video(video):
                            ...
                            username = video.get('author', {}).get('uniqueId', 'unknown')
    ...
    def _scrape_trending_event_content(self, days_back: int, max_videos: int = 100) -> List[TikTokEvent]:
                ...
                for video in videos:
                    try:
                        ...
                        if self._is_viral_event_content(video):
                            ...
                            username = video.get('author', {}).get('uniqueId', 'viral_user')
    ...
    def _is_viral_event_content(self, video: Dict) -> bool:
        ...
        hashtags = [tag.get('hashtagName', '').lower() for tag in video.get('textExtra', [])]
        ...
        urgency_indicators = [
            ...
            'omg', 'insane', 'wild', 'unreal', 'epic', 'legendary'
        ]
        ...
        location_indicators = [
            ...
            'refshaleøen', 'papirøen', 'sydhavnen'
        ]
        
        # Check for viral content patterns
        has_viral_language = any(indicator in all_text for indicator in viral_indicators)
        ...
        return (has_location and 
                (has_viral_language or has_urgency or high_engagement) and 
                not is_venue_promotion)
    ...
    def _extract_venue_from_viral_content(self, video: Dict) -> str:
        ...
        neighborhoods = [
            ...
            'Østerbro', 'Islands Brygge', 'Refshaleøen'
        ]
    ...
    def _is_event_video(self, video: Dict) -> bool:
        ...
        event_keywords = [
            'live', 'concert', 'show', 'event', 'tonight', 'saturday', 'friday',
            'party', 'fest', 'klub', 'night', 'aften', 'weekend'
        ]
        
        has_event_keywords = any(keyword in all_text for keyword in event_keywords)
        
        # Check for venue names
        has_venue = any(venue.lower() in all_text for venue in self.COPENHAGEN_VENUES.values())
    ...
    def _extract_artists_from_text(self, text: str) -> List[str]:
        ...
        common_words = {
            'TikTok', 'Copenhagen', 'Denmark', 'Friday', 'Saturday', 'Sunday',
            'Live', 'Music', 'Tonight', 'Event', 'Party', 'Club'
        }
...
def main():
    ...
    events = scraper.scrape_venues(
        venue_usernames=test_venues,
        days_back=14,
        max_videos_per_venue=20
    )
