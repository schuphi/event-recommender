...
class RecommendationExplanation(BaseModel):
    ...
    reasons: List[str] = Field(description="List of specific reasons for recommendation")
...
class LangChainRecommender:
    ...
    def _build_vector_store(self):
        ...
        try:
            ...
            documents = []
            for event in events:
                event_id, title, desc, date_time, price_min, price_max, venue, neighborhood, address, full_desc = event
    ...
    def get_recommendations(
        ...
        try:
            ...
            similar_docs = self.vector_store.similarity_search_with_score(
                search_query,
                k=num_recommendations * 2  # Get more to filter/rank
            )
            ...
            for doc, similarity_score in similar_docs[:num_recommendations]:
                ...
                recommendation = EventRecommendation(
                    ...
                    explanation=explanation.get("explanation", "Matches your preferences")
                )
    ...
    def _build_search_query(self, preferences: Dict) -> str:
        ...
        if "max_price" in preferences:
            query_parts.append(f"Affordable events under {preferences['max_price']} DKK")
