...
spec = importlib.util.spec_from_file_location(
    "data_collection", Path(__file__).parent.parent / "data-collection" / "__init__.py"
)
...
def _insert_test_data(conn):
    ...
    venues = [
        (
            "venue_1",
            "Culture Box",
            "Kronprinsessegade 54A, København K",
            55.6826,
            12.5941,
            "Indre By",
        ),
...
def cleanup_temp_files():
    ...
    temp_files = ["test_events.duckdb", "test_cache.pkl", "test_embeddings.json"]
