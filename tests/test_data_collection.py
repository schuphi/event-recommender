...
class TestInstagramScraper:
    ...
    def test_instagram_scraper_initialization(self):
        ...
        from data_collection.scrapers.social_scrapers.instagram import (
...
class TestTikTokScraper:
    ...
    def test_viral_content_detection(self):
        ...
        viral_video = {
            ...
            "stats": {"playCount": 50000, "diggCount": 2000, "commentCount": 150},
        ...
        promo_video = {
            ...
            "stats": {"playCount": 1000, "diggCount": 50, "commentCount": 10},
...
class TestDataValidation:
    ...
    def test_geographic_validation(self, validation_test_data):
        ...
        assert result.status in ["invalid", "needs_review"]
        assert any(
            "coordinate" in issue.lower() or "location" in issue.lower()
    ...
    def test_fuzzy_duplicate_detection(self):
        ...
        events = [
            ...
            },
            {
                ...
                + timedelta(days=1, hours=1),  # Similar time
            },
        ]
